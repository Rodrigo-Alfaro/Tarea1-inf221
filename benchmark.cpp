...
int main(){
    ...
    string medium_path = "medium_numbers.csv"; //setting paths for the datasets 
    ...
    begin = chrono::high_resolution_clock::now();
    //selection_sort(large_ss); take more than 25 min
    end = chrono::high_resolution_clock::now();
   ...
   // 2**7
    ...
    begin = chrono::high_resolution_clock::now();
    //vector<vector<int>> strassen_m8 = strassen(matrix_8, matrix_8_b); segm. error due to the matrix
    end = chrono::high_resolution_clock::now();
    ...
    begin = chrono::high_resolution_clock::now();
    // selection_sort(large_ss_50); take more than 25 min
    end = chrono::high_resolution_clock::now();
    ...
    begin = chrono::high_resolution_clock::now();
    //quicksort(large_qs_50, 0, large_qs_50.size() - 1); worst case when the elements are sorted, take +25min
    end = chrono::high_resolution_clock::now();
    ...
    begin = chrono::high_resolution_clock::now();
    //vector<vector<int>> strassen_m7_6b = strassen(matrix_c, matrix_d); error matrix size
    end = chrono::high_resolution_clock::now();
